...
public class Factura {
    ...
    public Factura(int numeroFactura, LocalDateTime fecha, Cliente cliente, Impuesto impuesto, double totalImpuesto) {
    ...
    public double getTotalFactura() {
        ...
        for (ItemFactura item : items) {
            totalFactura += item.getImporte() + totalImpuesto;
        }
        return totalFactura;
    }
    ...
    public void display() {
        ...
        System.out.println("Impuesto: " + this.impuesto.getPorcentaje() + "%");
        ...
        System.out.println();
        System.out.println("Total Impuesto               " + Formato.formatoMonedaPesos(this.getTotalImpuesto()));
