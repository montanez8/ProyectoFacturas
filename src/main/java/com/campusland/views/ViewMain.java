...
public class ViewMain {
    ...
    public static final ServiceImpuesto serviceImpuesto = new ServiceImpuestoImp(new RepositoryImpuestoImp());
    ...
    public static int menuMain() {
        System.out.println("\033[1;33m---Aplicación de Facturación-----\033[0m");
